...
const Header: React.FC<HeaderProps> = ({ redirectUrl }) => {
  return (
    <header className="fixed top-0 w-full z-50 bg-white shadow-md">
      <div className="container mx-auto flex justify-center items-center p-4">
        <a href={redirectUrl} className="flex items-center no-underline text-gray-800">
          <WhatsAppIcon />
          <span className="text-lg font-bold">Emagreça urgente Grupo</span>
        </a>
      </div>
    </header>
  );
