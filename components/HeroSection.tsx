...
const HeroSection: React.FC<HeroSectionProps> = ({ redirectUrl }) => {
  return (
    <section className="pt-24 pb-16 text-center bg-gray-50">
      <div className="container mx-auto px-4">
        <p className="uppercase tracking-widest text-emerald-600 font-semibold text-sm mb-2">
          suplemento natural
        </p>
        <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-4"
            dangerouslySetInnerHTML={{ __html: "Suplemento Alimentar Poderoso:<br /> O Segredo para Emagrecer Rápido, <span class='text-emerald-600'>Sem Passar Fome.</span>" }}
        />
        ...
        <a
          href={redirectUrl}
          className="inline-flex items-center justify-center bg-emerald-600 text-white font-bold text-xl py-4 px-10 rounded-lg shadow-lg hover:bg-emerald-700 transition-transform transform hover:scale-105"
        >
          <WhatsAppIcon />
          ENTRE NO GRUPO VIP
        </a>
        ...
        <div className="mt-10 max-w-lg mx-auto">
          <ul className="space-y-3 text-left">
            <li className="flex items-center text-lg">
              <CheckIcon />
              <span>Acelera o metabolismo 24/7</span>
            </li>
            <li className="flex items-center text-lg">
              <CheckIcon />
              <span>Inibe o apetite por doces e massas</span>
            </li>
            <li className="flex items-center text-lg">
              <CheckIcon />
              <span>Queima gordura localizada (barriga, braços, coxas)</span>
            </li>
          </ul>
        </div>
      </div>
